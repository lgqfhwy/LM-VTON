...
#                         --niter 20 \
#                         --niter_decay 20 \
#                         --checkpoints_dir ../new_pix2pix_mpv_results/checkpoint_train_no_skin_color_no_semantic_iter_40_content_fusion_pix2pixhd_mpv \
...
CUDA_VISIBLE_DEVICES=2 python content_fusion_mpv_test.py \
                        ...
                        --no_instance \
                        --checkpoints_dir ../new_pix2pix_mpv_results/checkpoint_train_no_skin_color_no_semantic_iter_40_content_fusion_pix2pixhd_mpv \
                        --results_dir ../mpv_images_test_pix2pix_mpv_results/images_train_no_skin_color_no_semantic_iter_40_content_fusion_pix2pixhd_mpv \
                        --dataroot /data/lgq/database/mpv \
                        --batchSize 1 \
                        --dataset_name content_fusion_mpv \
                        --gmm_path /data/lgq/virtual_try_on/cp_vton_mpv_images/densepose_mpv_One_model_add_point_add_vgg_refined_gmm_final_400000_images/refined_gmm_final.pth  \
