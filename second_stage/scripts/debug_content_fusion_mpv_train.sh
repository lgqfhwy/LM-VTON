...
CUDA_VISIBLE_DEVICES=1 python debug_content_fusion_mpv_train.py \
                        --phase train \
                        ...
                        --vgg_weight 10 \
                        --no_instance \
                        --checkpoints_dir ../new_pix2pix_results/debug_checkpoint_attention_content_fusion_pix2pixhd_mpv \
