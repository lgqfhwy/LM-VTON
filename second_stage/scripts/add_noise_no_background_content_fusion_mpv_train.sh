...
#                         --vgg_weight 10 \
#                         --no_instance \
#                         --checkpoints_dir ../pix2pix_results/checkpoint_add_noise_no_background_content_fusion_pix2pixhd_mpv \
...
CUDA_VISIBLE_DEVICES=0 python content_fusion_mpv_test.py \
                        ...
                        --no_instance \
                        --checkpoints_dir ../pix2pix_results/checkpoint_add_noise_no_background_content_fusion_pix2pixhd_mpv \
                        --results_dir ../pix2pix_results/images_add_noise_no_background_content_fusion_pix2pixhd_mpv \
                        --dataroot /data/lgq/database/mpv \
                        --batchSize 1 \
                        --dataset_name content_fusion_mpv \
                        --add_noise \
