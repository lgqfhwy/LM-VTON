...
#                         --no_instance \
#                         --block_version v3 \
#                         --checkpoints_dir ../new_pix2pix_results/checkpoint_attention_v3_content_fusion_pix2pixhd_mpv \
...
CUDA_VISIBLE_DEVICES=1 python content_fusion_mpv_test.py \
                        ...
                        --block_version v3 \
                        --checkpoints_dir ../new_pix2pix_results/checkpoint_attention_v3_content_fusion_pix2pixhd_mpv \
                        --results_dir ../new_pix2pix_results/images_attention_v3_content_fusion_pix2pixhd_mpv \
                        --dataroot /data/lgq/database/mpv \
                        --batchSize 1 \
                        --dataset_name content_fusion_mpv \
                        --gmm_path /data/lgq/new_graduate/results/images_refined_gmm_png_train_cloth_points/refined_gmm_final.pth \
