...
CUDA_VISIBLE_DEVICES=1 python content_fusion_mpv_train.py \
                        ...
                        --vgg_weight 10 \
                        --no_instance \
                        --checkpoints_dir ../new_pix2pix_results/checkpoint_warped_add_noise_content_fusion_pix2pixhd_mpv \
...
#                         --no_instance \
#                         --checkpoints_dir ../new_pix2pix_results/checkpoint_warped_add_noise_content_fusion_pix2pixhd_mpv \
#                         --results_dir ../new_pix2pix_results/images_warped_add_noise_content_fusion_pix2pixhd_mpv \
#                         --dataroot /data/lgq/database/mpv \
#                         --batchSize 1 \
#                         --dataset_name content_fusion_mpv \
#                         --warped \
