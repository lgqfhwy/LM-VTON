...
#                         --no_instance \
#                         --block_version v4 \
#                         --checkpoints_dir ../new_pix2pix_results/checkpoint_new_attention_v4_all_content_fusion_pix2pixhd_mpv \
#                         --dataroot /data/lgq/database/mpv \
#                         --batchSize 1 \
#                         --dataset_name content_fusion_mpv \
#                         --gmm_path /data/lgq/new_graduate/new_cp_vton_results/images_new_atten_v4_refined_gmm_png_train_cloth_points/atten_refined_gmm_final.pth \
...
CUDA_VISIBLE_DEVICES=2 python content_fusion_mpv_test.py \
                        ...
                        --block_version v4 \
                        --checkpoints_dir ../new_pix2pix_results/checkpoint_new_attention_v4_all_content_fusion_pix2pixhd_mpv \
                        --results_dir ../new_pix2pix_results/images_new_attention_v4_all_content_fusion_pix2pixhd_mpv \
                        --dataroot /data/lgq/database/mpv \
                        --batchSize 1 \
                        --dataset_name content_fusion_mpv \
                        --gmm_path /data/lgq/new_graduate/new_cp_vton_results/images_new_atten_v4_refined_gmm_png_train_cloth_points/atten_refined_gmm_final.pth \
