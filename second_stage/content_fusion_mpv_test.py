...
for i, data in enumerate(dataset):
    ...
    img_hole_hand, arm_label_map, warped_cloth, skin_color, output, real_image, only_remove_cloth = model.inference(Variable(data['label_parse']), Variable(data['warped_cloth']), Variable(data['arm_label_map']),
    ...
    visuals = OrderedDict([('origin_arm_label_map', util.tensor2label(data['arm_label_map'][0], 20)),
                            ...
                            ('only_remove_cloth', util.tensor2im(only_remove_cloth.data[0])),
