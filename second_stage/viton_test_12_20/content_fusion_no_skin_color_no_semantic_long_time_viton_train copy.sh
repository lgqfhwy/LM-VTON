...
#                         --vgg_weight 10 \
#                         --no_instance \
#                         --checkpoints_dir ../new_pix2pix_viton_results/checkpoint_no_skin_color_no_semantic_iter_40_viton_content_fusion_pix2pixhd_viton \
...
CUDA_VISIBLE_DEVICES=3 python content_fusion_mpv_test.py \
                        ...
                        --checkpoints_dir ../new_pix2pix_viton_results/checkpoint_no_skin_color_no_semantic_iter_40_viton_content_fusion_pix2pixhd_viton \
                        --no_skin_color_and_semantic \
                        --results_dir ../viton_images_test_pix2pix_mpv_results/images_no_skin_color_no_semantic_iter_40_viton_content_fusion_pix2pixhd_viton  \
                        --dataroot /data/lgq/database/viton_resize \
                        --batchSize 1 \
                        --dataset_name content_fusion_viton \
                        --gmm_path /data/lgq/virtual_try_on/cp_vton_viton_images/images_densepose_add_point_loss_One_model_refined_gmm_200000_images/step_200000.pth \
