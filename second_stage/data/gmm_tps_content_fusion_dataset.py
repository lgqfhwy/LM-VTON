...
class MpvDataset(BaseDataset):
    ...
    def __getitem__(self, index):        
        ...
        input_dict = {'label_parse': label_parse, 'cloth': c, 'cloth_mask': cm, 'arm_label_map': arm_label_map,
                       'fake_label_cloth_mask': fake_label_cloth_mask, 'image': im, 'agnostic':agnostic, 'cloth_points': c_point_plane, 
                       'person_points': p_point_plane, 'parse_cloth': im_c,
