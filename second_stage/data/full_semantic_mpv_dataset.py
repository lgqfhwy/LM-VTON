...
class MpvDataset(BaseDataset):
    ...
    def __getitem__(self, index):        
        ...
        cm = Image.open(osp.join(self.root, 'all', c_name[:-4] + "_mask.jpg"))
        c = self.transform(c)
        ...
        separate_parse_array = parse_array * (1- parse_cloth) + 
        ...
        input_dict = {'label_parse': label_parse, 'cloth': c, 'cloth_mask': cm, 'image': im,
