...
#                         --niter_decay 20 \
#                         --no_instance \
#                         --checkpoints_dir ../pix2pix_viton_results/checkpoint_retrain_viton_iter_40_content_fusion_pix2pixhd_viton \
...
CUDA_VISIBLE_DEVICES=1 python content_fusion_mpv_test.py \
                        ...
                        --no_instance \
                        --checkpoints_dir ../pix2pix_viton_results/checkpoint_retrain_viton_iter_40_content_fusion_pix2pixhd_viton \
                        --results_dir ../pix2pix_viton_results/images_long_train_iter_40_One_model_add_render_loss_refined_gmm_train_cloth_points \
                        --dataroot /data/lgq/database/viton_resize \
                        --batchSize 1 \
                        --dataset_name content_fusion_viton \
                        --gmm_path /data/lgq/virtual_try_on/cp_vton_viton_images/images_densepose_add_point_loss_One_model_refined_gmm_200000_images/step_200000.pth \
...
CUDA_VISIBLE_DEVICES=1 python content_fusion_mpv_test.py \
                        ...
                        --no_instance \
                        --checkpoints_dir ../pix2pix_viton_results/checkpoint_retrain_viton_iter_40_content_fusion_pix2pixhd_viton \
                        --results_dir ../pix2pix_viton_results/images_long_pair_train_iter_40_One_model_add_render_loss_refined_gmm_train_cloth_points \
                        --dataroot /data/lgq/database/viton_resize \
                        --batchSize 1 \
                        --dataset_name content_fusion_viton \
