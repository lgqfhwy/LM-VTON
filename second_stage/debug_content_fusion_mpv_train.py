...
for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
    ...
    for i, data in enumerate(dataset, start=epoch_iter):
        ...
        ############## Forward Pass ######################
        losses, img_hole_hand, arm_label_map, warped_cloth, skin_color, fake_image, real_image = model.forward(Variable(data['label_parse']), Variable(data['warped_cloth']), Variable(data['arm_label_map']),
